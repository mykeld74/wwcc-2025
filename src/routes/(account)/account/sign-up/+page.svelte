<script>
	...
	async function handleSignUp(e) {
		...
		try {
			...
			// Email verification is required, so sign-up does not start a session.
			submitted = true;
		} catch (err) {
...
<div class="authContainer">
	<div class="authCard">
		{#if submitted}
			...
			<p class="subtitle">One more step before you can sign in.</p>

			<div class="message success">
				We sent a verification link to <strong>{email}</strong>. Click it to confirm your address.
			</div>

			<p class="subtitle">
				New accounts start with no access. Once your email is verified, an administrator has to
				assign your role before you can use your account area.
			</p>
